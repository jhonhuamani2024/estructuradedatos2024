...
class Program
{
    static void Main()
    {
        ...
        // Crear matriz de números aleatorios
        ...
        for (int i = 0; i < filas; i++)
        {
            for (int j = 0; j < columnas; j++)
            {
                ...
                matrizAleatoria[i, j] = rand.NextDouble();
            }
        }

        // Imprimir algunos valores de la matriz para verificar
        Console.WriteLine("Algunos valores de la matriz aleatoria:");
        Console.WriteLine("matrizAleatoria[0, 0] = " + matrizAleatoria[0, 0]);
        Console.WriteLine("matrizAleatoria[50, 50] = " + matrizAleatoria[50, 50]);
        Console.WriteLine("matrizAleatoria[99, 99] = " + matrizAleatoria[99, 99]);

        // Puedes hacer más con la matriz aquí, como cálculos, manipulación de datos, etc.
    }
}
